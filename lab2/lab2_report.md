...
После завершения процесса деплоя я созал первую версию `hellodk-00001-8db`.

![Подтверждение деплоя](./screenshots/02_deployment_success.png)

### 2. Проверка работоспособности
Сервис успешно запустился и стал доступен по публичному URL.
...
Для тестирования механизмов обновления я создал 2 версию `hellodk-00002-5rg`. В настройках контейнера порт был изменен с дефолтного 8080 на **8090**. 
